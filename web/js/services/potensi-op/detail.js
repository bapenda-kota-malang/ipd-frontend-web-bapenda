...
function postDataFetch(data, xthis) {
	if(this.id) {
		...
		// xthis.refreshSelect(data.detailPotensiOp.kecamatan_id, xthis.kecamatans, `/kelurahan?kecamatan_kode=${data.detailPotensiOp.kecamatan.kode}&no_pagination=true`, xthis.kelurahans, 'kode');
		...
		console.log(data.rekening.objek);
