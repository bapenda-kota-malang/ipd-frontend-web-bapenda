...
urls = {
  preSubmit: '/terseleksi-pbb',
  postSubmit: '/terseleksi-pbb',
  submit: '/terseleksi-pbb/{id}/{kd}',
  dataSrc: '/terseleksi-pbb',
}
refSources = {
  ...
  imageUrl: '/static/img/',
  submitCetak: '/terseleksi-pbb/{id}/cetak',
  submitProcess: '/terseleksi-pbb-process',
  processCreate: '/terseleksi-pbb',
