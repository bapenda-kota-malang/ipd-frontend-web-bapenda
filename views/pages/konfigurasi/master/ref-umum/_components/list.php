	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-2 pt-1">Keterangan</div>
					<div class="col mb-2">
						<textarea v-model="entryData.keterangan" class="form-control"></textarea>
						<span class="text-danger" v-if="entryDataErr.keterangan">{{entryDataErr.keterangan}}</span>
					</div>
				</div>
				<div class="row">
