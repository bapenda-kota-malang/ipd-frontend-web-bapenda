...
$this->registerJsFile('@web/js/dto/pelaporan/penerimaan/print.js?v=20221108a');
$this->registerJsFile('@web/js/services/pelaporan/penerimaan/print.js?v=20221108a');
...
<div class="card mb-4">
	<div class="card-body">
		...
		<div class="row g-1">
			<div class="col-md-2 col-xl-1 pt-1">Tanggal Cetak</div>
			<div class="col-md col-lg-4 mb-2">
				<datepicker v-model="data.tanggalCetak" format="DD/MM/YYYY" />
			</div>
		</div>
	</div>
</div>
