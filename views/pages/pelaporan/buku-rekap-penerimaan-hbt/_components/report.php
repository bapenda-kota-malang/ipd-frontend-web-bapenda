...
$this->registerJsFile('@web/js/dto/pelaporan/buku-rekap-penerimaan-hbt/print.js?v=20221108a');
$this->registerJsFile('@web/js/services/pelaporan/buku-rekap-penerimaan-hbt/print.js?v=20221108a');
...
<div class="card mb-4">
	<div class="card-body">
		<div class="row g-1">
            ...
            <div class="col-md-3 col-xl-2 pt-1 text-lg-end pe-lg-3">Jenis Pajak</div>
