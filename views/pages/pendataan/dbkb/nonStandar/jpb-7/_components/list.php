...
$this->registerJsFile('@web/js/dto/dbkb/jpb7.js?v=20230405a');
$this->registerJsFile('@web/js/services/dbkb/jpb7.js?v=20230309a');
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row g-0 g-md-1">
					...
					<div class="xc mb-2">
						<vueselect v-model="filter.jenisDbkbJpb7"
							:options="jenisList"
				...
				<div class="row g-0 g-md-1">
					...
					<div class="xc mb-2">
						<vueselect v-model="filter.bintangDbkbJpb7"
							:options="bintangList"
							:reduce="item => item.kode"
							label="nama"
							code="kode"
				...
				<div class="row g-0 g-md-1">
					...
					<div class="xc-5 mb-2"><input v-model="filter.tahunDbkbJpb7" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Min</div>
					<div class="xc-5 mb-2"><input v-model="filter.lantaiMinJpb7" class="form-control" /></div>
					<div class="xc-6 pt-1 pe-2 text-end">Max</div>
					<div class="xc-5 mb-2"><input v-model="filter.lantaiMaxJpb7" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Nilai</div>
					<div class="xc-6 mb-2"><input v-model="filter.nilaiDbkbJpb7" class="form-control" /></div>
				</div>
			</div>
