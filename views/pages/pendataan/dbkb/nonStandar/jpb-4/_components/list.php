...
$this->registerJsFile('@web/js/dto/dbkb/jpb4.js?v=20230405a');
$this->registerJsFile('@web/js/services/dbkb/jpb4.js?v=20230309a');
...
<table class="table">
	...
	<tbody>
		...
		<tr v-else v-for="(item, idx) in data" >
			...
			<td>{{item.tahunDbkbJpb4}}</td>
			<td>{{item.kelasDbkbJpb4}}</td>
			<td class="text-end">{{item.lantaiMinJpb4}}</td>
			<td class="text-end">{{item.lantaiMaxJpb4}}</td>
			<td class="text-end">{{item.nilaiDbkbJpb4}}</td>
			<td class="text-end">
				<div class="btn-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row g-0 g-md-1">
					...
					<div class="xc-5 mb-2"><input v-model="filter.tahunDbkbJpb4" class="form-control" /></div>
					<div class="xc-6 pt-1 pe-2 text-end">Kelas</div>
					<div class="xc-5 mb-2"><input v-model="filter.kelasDbkbJpb4" type="number" min="1" max="4" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Min</div>
					<div class="xc-5 mb-2"><input v-model="filter.lantaiMinJpb4" class="form-control" /></div>
					<div class="xc-6 pt-1 pe-2 text-end">Max</div>
					<div class="xc-5 mb-2"><input v-model="filter.lantaiMaxJpb4" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Nilai</div>
					<div class="xc-6 mb-2"><input v-model="filter.nilaiDbkbJpb4" class="form-control" /></div>
				</div>
			</div>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Tahun</div>
					<div class="xc-5 mb-2"><input v-model="entryData.tahunDbkbJpb4" class="form-control" /></div>
					<div class="xc-6 pt-1 pe-2 text-end">Kelas</div>
					<div class="xc-5 mb-2"><input v-model="entryData.kelasDbkbJpb4" type="number" min="1" max="4" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Min</div>
					<div class="xc-5 mb-2"><input v-model="entryData.lantaiMinJpb4" class="form-control" /></div>
					<div class="xc-6 pt-1 pe-2 text-end">Max</div>
					<div class="xc-5 mb-2"><input v-model="entryData.lantaiMaxJpb4" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Nilai</div>
					<div class="xc-6 mb-2"><input v-model="entryData.nilaiDbkbJpb4" class="form-control" /></div>
				</div>
			</div>
			<div class="modal-footer">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="xc-1">:</div>
					<div class="xc mb-1">{{entryData.tahunDbkbJpb4}}</div>
				</div>
				<div class="row">
					<div class="xc-5 ps-4">Kelas</div>
					<div class="xc-1">:</div>
					<div class="xc mb-1">{{entryData.kelasDbkbJpb4}}</div>
				</div>
				<div class="row">
					<div class="xc-5 ps-4">Min</div>
					<div class="xc-1">:</div>
					<div class="xc mb-1">{{entryData.lantaiMinJpb4}}</div>
				</div>
				<div class="row">
					<div class="xc-5 ps-4">Max</div>
					<div class="xc-1">:</div>
					<div class="xc mb-1">{{entryData.lantaiMaxJpb4}}</div>
				</div>
				<div class="row">
					<div class="xc-5 ps-4">Nilai</div>
					<div class="xc-1">:</div>
					<div class="xc mb-1">{{entryData.nilaiDbkbJpb4}}</div>
				</div>
