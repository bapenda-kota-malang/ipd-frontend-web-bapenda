...
$this->registerJsFile('@web/js/dto/dbkb/jpb3.js?v=20230405a');
$this->registerJsFile('@web/js/services/dbkb/jpb3.js?v=20230309a');
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row g-0 g-md-1">
					...
					<div class="xc-5 mb-2"><input v-model="filter.tahunDbkbJpb3" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Lebar Min</div>
					<div class="xc-5 mb-2"><input v-model="filter.lebarBentukMinDbkbJpb3" class="form-control" /></div>
					<div class="xc-6 pt-1 text-end">Lebar Max</div>
					<div class="xc-5 mb-2"><input v-model="filter.lebarBentukMaxDbkbJpb3" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Tinggi Min</div>
					<div class="xc-5 mb-2"><input v-model="filter.tinggiKolomMinDbkbJpb3" class="form-control" /></div>
					<div class="xc-6 pt-1 text-end">Tinggi Max</div>
					<div class="xc-5 mb-2"><input v-model="filter.tinggiKolomMaxDbkbJpb3" class="form-control" /></div>
				</div>
				<div class="row g-0 g-md-1">
					<div class="xc-4 pt-1">Nilai</div>
					<div class="xc-6 mb-2"><input v-model="filter.nilaiDbkbJpb3" class="form-control" /></div>
				</div>
			</div>
