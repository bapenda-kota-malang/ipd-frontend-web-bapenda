...
$this->registerJsFile('@web/js/services/keberatan/entry-pembetulan.js?v=20221108a');
?>
...
<div class="card mb-4">
	<div class="card-body">
		...
		<div class="row align-items-center g-0 mb-2">
			...
			<div class="col-1 text-center">:</div>
			<div class="col-4 d-flex">
				<input v-model="data.nomorSKOld1" type="text" class="form-control text-end me-2" style="width: 80px;">
		...
		<div class="row align-items-center g-0 mb-2">
			...
			<div class="col-1 text-center">:</div>
			<div class="col-1">
				<datepicker v-model="data.tanggalSK" type="year" format="YYYY" />
			</div>
		</div>
		<div class="row align-items-center g-0 mb-2">
		...
		<div class="row align-items-center g-0 mb-2">
			...
			<div class="col-1 text-center">:</div>
			<div class="col-1">
				<datepicker v-model="data.tanggalBAKantor" type="year" format="YYYY" />
			</div>
		</div>
		<div class="row align-items-center g-0 mb-2">
		...
		<div class="row align-items-center g-0 mb-2">
			...
			<div class="col-1 text-center">:</div>
			<div class="col-1">
				<datepicker v-model="data.tanggalBALapangan" type="year" format="YYYY" />
			</div>
		</div>
		<hr>
