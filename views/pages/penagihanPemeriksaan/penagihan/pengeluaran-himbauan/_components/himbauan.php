		...
		<div class="row">
			<div>
				<div class="row g-0 mb-3">
					...
					<div class="col-md-9 col-lg-11 col-xl-10">
						<select class="form-select" v-model="data.buku">
							<option v-for="item in bukus" :value="item.id">{{item.name}}</option>
						</select>
						<span class="text-danger" v-if="dataErr.buku">{{dataErr.bukus}}</span>
					</div>
				</div>
				<div class="row g-0 mb-3">
				...
				<div class="row g-0 mb-3">
					...
					<div class="col-md-6"><input v-model="data.tanggalTerbit" class="form-control" /></div>
				</div>
				<div class="row g-0 mb-3">
