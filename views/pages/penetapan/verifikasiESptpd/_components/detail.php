	...
	<div class="p-3">
		...
		<div v-else>
			...
			<div class="row g-1 mt-2">
				<div class="col-md-3 pt-1">Menggunakan Kas Register / komputer / pos :</div>
				<div class="col-md-6 mb-2">
					<div class="row pt-1">
						<div class="col-md-3">
							<div class="form-check">
								<input v-model="data.kas" class="form-check-input" type="radio" name="kasRadio" id="kasRadio1" value="ya" />
								<label class="form-check-label" for="kasRadio1">
									Ya
								</label>
							</div>
						</div>
						<div class="col mb-1">
							<div class="form-check">
								<input v-model="data.kas" class="form-check-input" type="radio" name="kasRadio" id="kasRadio2" value="tidak" />
								<label class="form-check-label" for="kasRadio2">
									Tidak
								</label>
							</div>
						</div>
			...
			<div class="row g-1 mt-2">
				<div class="col-md-3 pt-1">Mengadakan Pembukuan / Pencatatan :</div>
				<div class="col-md-6 mb-2">
					<div class="row pt-1">
						<div class="col-md-3">
							<div class="form-check">
								<input v-model="data.pembukuan" class="form-check-input" type="radio" name="pembukuanRadio" id="pembukuanRadio1" value="ya" />
								<label class="form-check-label" for="pembukuanRadio1">
									Ya
								</label>
							</div>
						</div>
						<div class="col mb-1">
							<div class="form-check">
								<input v-model="data.pembukuan" class="form-check-input" type="radio" name="pembukuanRadio" id="pembukuanRadio2" value="tidak" />
								<label class="form-check-label" for="pembukuanRadio2">
									Tidak
								</label>
							</div>
						</div>
