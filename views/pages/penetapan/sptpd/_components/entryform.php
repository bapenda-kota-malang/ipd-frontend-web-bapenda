	...
	<div class="p-3">
		...
		<template v-else>
			...
			<div v-if="rekening_objek == '01'" v-for="(item, idx) in data.dataDetails" class="row g-1">
				<div class="col-md-3">
					<input v-model="data.dataDetails[idx].golonganKamar" class="form-control">
				</div>
				<div class="col-md-3">
					<input v-model="data.dataDetails[idx].tarif" type="number" class="form-control">
				</div>
				<div class="col-md-3">
					<input v-model="data.dataDetails[idx].jumlahKamar" type="number" class="form-control">
				</div>
				<div class="col-md-3">
					<input v-model="data.dataDetails[idx].jumlahKamarYangLaku" type="number" class="form-control">
				</div>
			</div>
			<div v-if="rekening_objek == '02'" class="row g-1">
				<div class="col-md-2">
