...
<ul class="nav nav-pills nav-fill">
    <li class="nav-item">
        <a class="nav-link <?php echo $type == "oa" ? " active" : "" ?>" href="/penetapan/massal-skpdkb/pajak-parkir?type=oa">OA</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo $type == "sa" ? " active" : "" ?>" href="/penetapan/massal-skpdkb/pajak-parkir?type=sa">SA</a>
    </li>
</ul>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <?php if ($type == "oa") { ?>
                                <li>
                                    <a class="dropdown-item" :href="'/penetapan/massal-skpdkb/pajak-parkir/' + item.id + '/detail?type=oa'">Detail</a>
                                </li>
                            <?php } else if ($type == "sa") { ?>
                                <li>
                                    <a class="dropdown-item" :href="'/penetapan/massal-skpdkb/pajak-parkir/' + item.id + '/detail?type=sa'">Detail</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
