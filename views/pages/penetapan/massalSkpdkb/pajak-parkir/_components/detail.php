...
if ($type == 'oa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/parkir/oa/detail.js?v=20221117a');
} else if ($type == 'sa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/parkir/sa/detail.js?v=20221117a');
}
