...
<ul class="nav nav-pills nav-fill">
    <li class="nav-item">
        <a class="nav-link <?php $type == "oa" ? " active" : "" ?>" href="/penetapan/massal-skpdkb/pajak-air-tanah?type=oa">OA</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" <?php $type == "sa" ? " active" : "" ?> href="/penetapan/massal-skpdkb/pajak-air-tanah?type=sa">SA</a>
    </li>
</ul>
