...
if ($type == 'oa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/air-tanah/oa/list.js?v=20221117a');
} else if ($type == 'sa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/air-tanah/sa/list.js?v=20221117a');
}
?>
<!-- Nav tabs -->
<ul class="nav nav-pills nav-fill">
    <li class="nav-item">
        <a class="nav-link <?php echo ($type == "oa") ? " active" : "" ?>" href="/penetapan/massal-skpdkb/pajak-air-tanah?type=oa">OA</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo ($type == "sa") ? " active" : "" ?>" href="/penetapan/massal-skpdkb/pajak-air-tanah?type=sa">SA</a>
    </li>
</ul>
