...
if ($type == 'oa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/air-tanah/oa/detail.js?v=20221117a');
} else if ($type == 'sa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/air-tanah/sa/detail.js?v=20221117a');
}
