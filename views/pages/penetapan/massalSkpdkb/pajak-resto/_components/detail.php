...
if ($type == 'oa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/resto/oa/detail.js?v=20221117a');
} else if ($type == 'sa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/resto/sa/detail.js?v=20221117a');
}
