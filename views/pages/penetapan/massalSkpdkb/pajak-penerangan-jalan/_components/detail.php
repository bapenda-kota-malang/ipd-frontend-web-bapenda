...
if ($type == 'oa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/penerangan-jalan/oa/detail.js?v=20221117a');
} else if ($type == 'sa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/penerangan-jalan/sa/detail.js?v=20221117a');
}
