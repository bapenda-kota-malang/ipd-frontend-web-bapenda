...
if ($type == 'oa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/reklame/oa/list.js?v=20221117a');
} else if ($type == 'sa') {
    $this->registerJsFile('@web/js/services/massal-skpdkb/reklame/sa/list.js?v=20221117a');
}
?>
<!-- Nav tabs -->
