...
<ul class="nav nav-pills nav-fill">
    <li class="nav-item">
        <a class="nav-link <?php echo $type == "oa" ? " active" : "" ?>" href="/penetapan/massal-skpdkb/pajak-hiburan?type=oa">OA</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo $type == "sa" ? " active" : "" ?>" href="/penetapan/massal-skpdkb/pajak-hiburan?type=sa">SA</a>
    </li>
</ul>
